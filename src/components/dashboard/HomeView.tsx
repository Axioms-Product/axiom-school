      ...
      <div className="max-w-7xl mx-auto space-y-3 sm:space-y-4">
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white border-0 shadow-xl">
          <CardContent className="p-3 sm:p-6">
            <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 sm:p-4 text-center self-end sm:self-auto">
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-blue-600">{pendingHomework}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-orange-600">{notices.length}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-green-600">{upcomingEvents.length}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-purple-600">{averageMarks}%</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-indigo-600">{unreadMessages}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-blue-600">{teacherStats.totalStudents}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-green-600">{teacherStats.assignmentsGiven}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-orange-600">{teacherStats.eventsPlanned}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-purple-600">{messages.length}</p>
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-2xl font-bold text-indigo-600">{currentUser?.class}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          <Card className="shadow-lg border-0">
            <CardHeader className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-t-lg p-3 sm:p-6">
              ...
              {isStudent ? (
                <div className="space-y-4 sm:space-y-6">
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-xs sm:text-sm font-medium text-gray-700">Homework Completion</span>
                      <span className="text-xs sm:text-sm font-bold text-gray-900">{Math.round(homeworkProgress)}%</span>
                    </div>
                    <Progress value={homeworkProgress} className="h-2 sm:h-3" />
                  </div>
                  
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="text-center p-3 sm:p-4 bg-green-50 rounded-xl">
                      <div className="text-lg sm:text-2xl font-bold text-green-600 mb-1">{completedHomework}</div>
                      <div className="text-xs sm:text-sm text-gray-600">Completed</div>
                    </div>
                    <div className="text-center p-3 sm:p-4 bg-orange-50 rounded-xl">
                      <div className="text-lg sm:text-2xl font-bold text-orange-600 mb-1">{pendingHomework}</div>
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-xl">
                    <div className="text-lg sm:text-2xl font-bold text-blue-600 mb-1">{homework.length}</div>
                    <div className="text-xs sm:text-sm text-gray-600">Assignments</div>
                  </div>
                  <div className="text-center p-3 sm:p-4 bg-green-50 rounded-xl">
                    <div className="text-lg sm:text-2xl font-bold text-green-600 mb-1">{notices.length}</div>
                    <div className="text-xs sm:text-sm text-gray-600">Notices</div>
                  </div>
                </div>
              )}
            </CardContent>
          ...
          {/* New Performance Insights Component */}
          <Card className="shadow-lg border-0">
            <CardHeader className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-t-lg p-3 sm:p-6">
              <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
                <Brain className="h-4 w-4 sm:h-5 sm:w-5" />
                {isStudent ? 'Performance Insights' : 'Teaching Analytics'}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3 sm:p-6">
              {isStudent ? (
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">Avg Study Time</p>
                        <p className="text-xs text-gray-500">Per day this week</p>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-emerald-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">Active Students</p>
                        <p className="text-xs text-gray-500">This week</p>
                      </div>
                    </div>
                    <div className="text-xl font-bold text-emerald-600">{Math.round(studentsInClass.length * 0.85)}</div>
                  </div>
            ...
            <CardContent className="p-3 sm:p-6">
              <div className="space-y-3 sm:space-y-4">
                {homework.slice(0, 3).map((hw) => {
                  ...
                  return (
                    <div key={hw.id} className="flex items-center gap-3 p-2 sm:p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-900 truncate">{hw.title}</p>
                ...
                {homework.length === 0 && (
                  <div className="text-center py-6 sm:py-8 text-gray-500">
                    ...
                    <p className="text-xs sm:text-sm">No homework assigned yet</p>
                  </div>
                )}
              </div>
            </CardContent>
        ...
        {/* Quick Actions */}
        <Card className="shadow-lg border-0">
          <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-t-lg p-3 sm:p-6">
            <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
        ...
        {upcomingEvents.length > 0 && (
          <Card className="shadow-lg border-0">
            <CardHeader className="bg-gradient-to-r from-green-500 to-teal-600 text-white rounded-t-lg p-3 sm:p-6">
              <CardTitle className="flex items-center gap-2 text-sm sm:text-base">
            ...
            <CardContent className="p-3 sm:p-6">
              <div className="space-y-3">
                {upcomingEvents.map((event) => (
                  <div key={event.id} className="flex items-center gap-3 p-2 sm:p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
