    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900">
      <div className="space-y-8 p-6">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="text-white">
                  ...
                  <blockquote className="text-blue-100 italic text-xl max-w-3xl leading-relaxed">
                ...
                <div className="mt-8 lg:mt-0 lg:ml-8">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center shadow-xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-blue-900 dark:text-blue-100">{stats.homeworks}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-purple-900 dark:text-purple-100">{stats.notices}</p>
                </div>
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-green-700 dark:text-green-300 mb-1">Events</p>
                  <p className="text-xl font-bold text-green-900 dark:text-green-100">{stats.events}</p>
                </div>
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-amber-700 dark:text-amber-300 mb-1">Messages</p>
                  <p className="text-xl font-bold text-amber-900 dark:text-amber-100">{stats.unreadMessages}</p>
                </div>
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-indigo-700 dark:text-indigo-300 mb-1">Exams</p>
                  <p className="text-xl font-bold text-indigo-900 dark:text-indigo-100">{stats.exams}</p>
                </div>
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-900/20 dark:to-rose-800/20">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-medium text-rose-700 dark:text-rose-300 mb-1">Tasks</p>
                  <p className="text-xl font-bold text-rose-900 dark:text-rose-100">{stats.completedTasks}</p>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Progress Overview */}
          <Card className="lg:col-span-2 border-0 shadow-xl bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="h-16 w-16 mx-auto mb-3 rounded-2xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                ...
                <div className="text-center">
                  <div className="h-16 w-16 mx-auto mb-3 rounded-2xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                ...
                <div className="text-center">
                  <div className="h-16 w-16 mx-auto mb-3 rounded-2xl bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center">
              ...
              <div className="pt-4 border-t">
                <Link to="/dashboard/events" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">
          ...
          <CardContent>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
              <Link to="/dashboard/homework" className="block group">
                <div className="h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex flex-col items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl">
              ...
              <Link to="/dashboard/notices" className="block group">
                <div className="h-20 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl flex flex-col items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl">
              ...
              <Link to="/dashboard/events" className="block group">
                <div className="h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex flex-col items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl">
              ...
              <Link to="/dashboard/messages" className="block group">
                <div className="h-20 bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl flex flex-col items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl">
              ...
              <Link to="/dashboard/marks" className="block group">
                <div className="h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex flex-col items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl">
              ...
              <Link to="/dashboard/exams" className="block group">
                <div className="h-20 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex flex-col items-center justify-center text-white hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl">
