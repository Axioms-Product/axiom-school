...
export const ExitConfirmDialog = ({ open, onOpenChange, onConfirm }: ExitConfirmDialogProps) => {
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="w-[95vw] max-w-sm mx-auto rounded-2xl border-0 shadow-2xl bg-white/98 backdrop-blur-lg">
        <AlertDialogHeader className="text-center space-y-4 pb-2">
          ...
          <AlertDialogDescription className="text-gray-600 text-base leading-relaxed px-2">
        ...
        <AlertDialogFooter className="flex flex-col gap-3 pt-6">
          ...
          <AlertDialogCancel 
            ...
            className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 border-0 h-12 rounded-xl font-medium transition-all duration-200 order-2"
          >
