        ...
        <div className="relative mb-8 md:mb-12">
          ...
          <div className="relative p-4 md:p-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-6">
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-3 py-2 border border-green-200">
                <span className="text-xs md:text-sm font-medium">{attendanceStats.percentage}% Attendance</span>
              </div>
