      ...
      <div className="container mx-auto max-w-7xl py-4 md:py-8 px-4">
        ...
        <div className="relative mb-8 md:mb-12">
          ...
          <div className="relative p-4 md:p-8 text-center">
            ...
            {/* Quick Stats - Removed attendance */}
        ...
        <div className="grid lg:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="lg:col-span-1 space-y-4 md:space-y-6">
            ...
            {/* Progress & Stats Card - Removed attendance stats */}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 mt-4">
                  <div className="bg-white/50 rounded-lg p-3 text-center">
                    ...
                    <div className="text-xs text-blue-500">Total Exams</div>
                  </div>
                  <div className="bg-white/50 rounded-lg p-3 text-center">
                    <div className="text-lg font-bold text-purple-600">{profileUser?.class}</div>
                    <div className="text-xs text-purple-500">Current Class</div>
                  </div>
                </div>
              </CardContent>
            </Card>
